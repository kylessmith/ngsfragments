...
/* "ngsfragments/read_sam/ReadSam.pyx":23
 * 
 * 
...
static labeled_aiarray_t *__pyx_f_12ngsfragments_8read_sam_7ReadSam_sam_read(char *__pyx_v_samfile_name, int __pyx_v_min_size, int __pyx_v_max_size, int __pyx_v_paired, int __pyx_v_qcfail, int __pyx_v_mapq_cutoff, float __pyx_v_proportion) {
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":26
 * 								 float proportion):
 * 
 ...
 */
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":28
 * 	cdef labeled_aiarray_t *cintervals = labeled_aiarray_init()
 * 	# Set random generator seed
 * 	srand(time.time())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_time); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 28, __pyx_L1_error)
  ...
  __pyx_t_4 = __Pyx_PyInt_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_4 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  srand(__pyx_t_4);

  /* "ngsfragments/read_sam/ReadSam.pyx":31
 * 
 * 	# Initialize
 ...
 */
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":34
 * 					  proportion)
 * 
 * 	return cintervals             # <<<<<<<<<<<<<<
 * 
...
/* "ngsfragments/read_sam/ReadSam.pyx":38
 * 
 * 
...
static PyObject *__pyx_pw_12ngsfragments_8read_sam_7ReadSam_1read_fragments(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("read_fragments (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_min_size)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 1); __PYX_ERR(0, 38, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 2); __PYX_ERR(0, 38, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_paired)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 3); __PYX_ERR(0, 38, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_qcfail)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 4); __PYX_ERR(0, 38, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mapq_cutoff)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 5); __PYX_ERR(0, 38, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_proportion)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, 6); __PYX_ERR(0, 38, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "read_fragments") < 0)) __PYX_ERR(0, 38, __pyx_L3_error)
      }
    ...
    __pyx_v_min_size = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_min_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_max_size = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_max_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_paired = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_paired == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_qcfail = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_qcfail == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_mapq_cutoff = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_mapq_cutoff == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_proportion = __pyx_PyFloat_AsFloat(values[6]); if (unlikely((__pyx_v_proportion == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("read_fragments", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 38, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ngsfragments.read_sam.ReadSam.read_fragments", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_samfile_name), (&PyUnicode_Type), 1, "samfile_name", 1))) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_1 = PyUnicode_AsEncodedString(__pyx_v_samfile_name, NULL, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyBytes_AsWritableString(__pyx_v_bname); if (unlikely((!__pyx_t_2) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
  __pyx_v_name = __pyx_t_2;

  /* "ngsfragments/read_sam/ReadSam.pyx":44
 * 	cdef bytes bname = samfile_name.encode()
 * 	cdef char *name = bname
 * 	cdef labeled_aiarray_t *cintervals = sam_read(name, min_size, max_size, paired, qcfail, mapq_cutoff,             # <<<<<<<<<<<<<<
 * 				  								  proportion)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_CallNoArg(((PyObject *)__pyx_ptype_6ailist_25LabeledIntervalArray_core_LabeledIntervalArray)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_fragments = ((struct __pyx_obj_6ailist_25LabeledIntervalArray_core_LabeledIntervalArray *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "ngsfragments/read_sam/ReadSam.pyx":49
 * 	print("Done reading")
 * 	cdef LabeledIntervalArray fragments = LabeledIntervalArray()
 * 	fragments.set_list(cintervals)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":51
 * 	fragments.set_list(cintervals)
 * 
 * 	return fragments             # <<<<<<<<<<<<<<
 * 
 ...
 * 	fragments.set_list(cintervals)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Done_reading); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 47, __pyx_L1_error)
 ...
 * 	"""
 */
  __pyx_tuple__22 = PyTuple_Pack(11, __pyx_n_s_samfile_name, __pyx_n_s_min_size, __pyx_n_s_max_size, __pyx_n_s_paired, __pyx_n_s_qcfail, __pyx_n_s_mapq_cutoff, __pyx_n_s_proportion, __pyx_n_s_bname, __pyx_n_s_name, __pyx_n_s_cintervals, __pyx_n_s_fragments); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(7, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ngsfragments_read_sam_ReadSam_py, __pyx_n_s_read_fragments, 38, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 38, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":16
 ...
 */
  ...
  /* "ngsfragments/read_sam/ReadSam.pyx":19
 * cimport numpy as np
 * 
 * import time             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_time, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 	"""
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12ngsfragments_8read_sam_7ReadSam_1read_fragments, NULL, __pyx_n_s_ngsfragments_read_sam_ReadSam); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_read_fragments, __pyx_t_1) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
