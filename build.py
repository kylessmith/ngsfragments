...
def build():
    ...
    #ext_modules = cythonize(ext_modules, include_path=include_dirs, gdb_debug=False, language_level=3)

    distribution = Distribution({"name": "extended", "ext_modules": ext_modules, 'clean_ext': clean_ext})
