...
modules = [
    ...
    dict(name="ngsfragments.peak_calling.RunningMedian",
         sources=["ngsfragments.peak_calling.RunningMedian".replace(".", os.path.sep)+".pyx"] + shared_htslib_sources + os_c_files,
         libraries=external_htslib_libraries),
    dict(name="ngsfragments.peak_calling.RunningMean",
         sources=["ngsfragments.peak_calling.RunningMean".replace(".", os.path.sep)+".pyx"] + shared_htslib_sources + os_c_files,
         libraries=external_htslib_libraries),
    dict(name="ngsfragments.peak_calling.CallPeaks",
         sources=["ngsfragments.peak_calling.CallPeaks".replace(".", os.path.sep)+".pyx"] + shared_htslib_sources + os_c_files,
         libraries=external_htslib_libraries),
...
metadata = dict(
    ...
    setup_requires = ["cython", "numpy","ailist","linear_segment", "pysam", "matplotlib","seaborn","bokeh","scipy"],
    install_requires = ["numpy","ailist","linear_segment","intervalframe", "statsmodels", "h5py","pysam"],
